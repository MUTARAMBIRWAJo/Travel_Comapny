...
export default function TravelerRequestPage() {
            ...
            <Card>
                  ...
                  <CardContent className="text-center space-y-4">
                        ...
                        <div className="flex gap-4 justify-center">
                              <Button variant="outline" onClick={() => window.location.href = '/dashboard/traveler'}>
                                    View My Requests
                              </Button>
                              <Button onClick={() => window.location.href = '/dashboard/traveler/trips'}>
                                    View My Trips
                              </Button>
                        </div>
                  </CardContent>
      ...
      return (
            <div className="space-y-8">
                  <div>
                        <h2 className="text-3xl font-bold">Create Travel Request</h2>
                        <p className="text-muted-foreground">Submit a new travel request for our team to process</p>
                  </div>
